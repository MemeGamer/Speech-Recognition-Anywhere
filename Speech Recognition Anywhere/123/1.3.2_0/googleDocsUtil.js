...
var googleDocsUtil = function() {
    ...
    function getGoogleDocument() {
        ...
        var globalIndex = 0;
        var selectedText = "";
        var previousText = ""; // 9/18/2017 - Added by Jeff
        ...
        for (var i = 0; i < paragraphrenderers.length; i++) {
            ...
            for (var j = 0; j < lineviews.length; j++) {
                ...
                for (var k = 0; k < wordhtmlgeneratorWordNodes.length; k++) {
                	var linefeed = 0; // 8/20/2017 - Added by Jeff to preserve linefeeds
                    ...
                    if (caretRect) {
                        ...
                        if (lineCount == caretLine) 
							previousText = cleanDocumentText(wordhtmlgeneratorWordNodes[k].innerText).substring(0,caretLineIndex); // 9/18/2017 - Added by Jeff
                    }
                    ...
                    for (var l = 0; l < selectionOverlays.length; l++) {
                        ...
                        if (doesRectsOverlap(wordhtmlgeneratorWordNodeRect, selectionOverlay.getBoundingClientRect())) {
                            ...
                            linefeed = 1; // 8/20/2017 - Added by Jeff to preserve linefeeds
                        }
                    }
                ...
                if (linefeed == 1) { selectedText += "\r\n"; linefeed = 2; }; // 8/20/2017 - Added by Jeff to preserve linefeeds
                text.push(lineText);
                lineCount++;
            }
        }
